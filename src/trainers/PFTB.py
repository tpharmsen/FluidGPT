...
class PFTBTrainer:
    ...
    def train(self):
        ...
        if self.wandb_enabled:
            ...
            wandb.init(project="BubbleML_DS_PF", name=self.model_name + '_wd=' + str(self.weight_decay) + '_maxpf=' + str(self.max_unrolling) + '_bs=' + str(self.batch_size), config=self.wandb_config)
