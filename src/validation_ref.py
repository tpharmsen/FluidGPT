...
python3 src/validation_ref.py --trainer MTT --CB surf-high --CD spike-preprocAll --CM ar-final-d2 --CT ar-final --out EZref --model_path models/epoch=0048-val_SS_loss_checkpoint=0.004346.ckpt --calc spectra --dsplit 4 --fm_samples 1
"""
...
class ModelValidation:
    ...
    def calculate_spectra_plots_per_dataset(self):
        ...
        for d, dataset in enumerate(self.valtraj_datasets):
            ...
            save_error_path = self.cb.save_path + "validation/" + self.trainer + "/" + self.cb.folder_out + "spectra_error/ref/"
            os.makedirs(save_error_path, exist_ok=True)
